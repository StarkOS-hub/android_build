...
""" % bcb_dev)
  ...
  # Build info
  script.Print("==========================================");
  script.Print("   _____ _             _     ____   _____ ");
  script.Print("  / ____| |           | |   / __ \ / ____|");
  script.Print(" | (___ | |_ __ _ _ __| | _| |  | | (___  ");
  script.Print("  \___ \| __/ _` | '__| |/ / |  | |\___ \ ");
  script.Print("  ____) | || (_| | |  |   <| |__| |____) |");
  script.Print(" |_____/ \__\__,_|_|  |_|\_\\____/|_____/ ");
  script.Print("==========================================");
  script.Print("       with love by JigenxOhtsusuki       ");
  script.Print("==========================================");
